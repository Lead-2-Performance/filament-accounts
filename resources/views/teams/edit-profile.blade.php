<x-filament-panels::page>
    <x-filament-panels::form wire:submit="updateProfile">
        ...
        <x-filament-panels::form.actions alignment="right" :actions="$this->getUpdateProfileFormActions()" />
    ...
    @if (filament()->getPlugin('filament-saas-accounts')->editPassword)
        <x-filament-panels::form wire:submit="updatePassword">
            ...
            <x-filament-panels::form.actions alignment="right" :actions="$this->getUpdatePasswordFormActions()" />
        </x-filament-panels::form>
    @endif
